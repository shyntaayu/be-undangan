...
final class CorsMiddleware implements MiddlewareInterface
{
    public function handle(Request $request, Closure $next)
    {
        ...
        $header->set('Access-Control-Allow-Origin', 'https://shyntaayu.github.io/, http://localhost:5050');
        $header->set('Access-Control-Allow-Headers', 'https://shyntaayu.github.io/, http://localhost:5050');
